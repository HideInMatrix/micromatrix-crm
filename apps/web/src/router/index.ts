    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'enterprise-ui-settings',
          component: () => import('@/views/system/enterprise-settings/SettingsView.vue'),
          meta: {
            title: '界面设置',
            perm: 'system:setting',
            topMenuGroup: 'enterprise-settings',
            topMenuLabel: '界面设置',
            topMenuOrder: 10,
          },
        },
        {
          path: 'system/settings/third-party',
          name: 'enterprise-third-party-settings',
          component: () => import('@/views/system/enterprise-settings/SettingsView.vue'),
          meta: {
            title: '第三方',
            perm: 'system:setting',
        ...
        {
          path: 'system/settings/mail',
          name: 'enterprise-mail-settings',
          component: () => import('@/views/system/enterprise-settings/SettingsView.vue'),
          meta: {
            title: '邮件设置',
            perm: 'system:setting',
        ...
        },
        {
          ...
          name: 'enterprise-model-settings',
          component: () => import('@/views/system/enterprise-settings/SettingsView.vue'),
          meta: {
            title: '模型设置',
            perm: 'system:setting',
        ...
        {
          path: 'system/settings/global-tasks',
          name: 'enterprise-global-task-settings',
          component: () => import('@/views/system/enterprise-settings/SettingsView.vue'),
          meta: {
            title: '全局任务',
            perm: 'system:setting',
