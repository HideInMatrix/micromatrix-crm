          ...
          >
            <div class="flex items-start gap-3">
              <van-badge :dot="!item.readAt">
                <div class="flex h-8 w-8 items-center justify-center rounded-[6px] bg-[var(--primary-7)]">
              ...
              <div class="min-w-0 flex-1">
                ...
                <div v-if="item.content" class="mt-2 line-clamp-2 text-xs leading-5 text-[var(--text-n4)]">
                  {{ item.content }}
                </div>
                <div v-if="item.linkLabel" class="mt-2 text-xs text-[var(--primary-8)]">
                  {{ item.linkLabel }}
                </div>
              </div>
            </div>
