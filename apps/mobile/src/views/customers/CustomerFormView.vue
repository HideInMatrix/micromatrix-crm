...
const form = useCustomerForm(customerId)
const customerFormRef = ref<InstanceType<typeof MobileCustomerForm> | null>(null)
const draftKey = computed(() =>
  customerId.value ? 'customer-edit:' + customerId.value : 'customer-create',
)
