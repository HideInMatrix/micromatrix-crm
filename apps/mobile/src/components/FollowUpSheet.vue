    ...
    <div class="p-4 h-full flex flex-col">
      ...
      <div class="mb-3">
        ...
        <van-field
          ...
          autosize
          placeholder="跟进内容..."
          class="!bg-[#f7f8fa] rounded"
        />
        <van-button type="primary" size="small" block class="mt-2" :loading="saving" @click="submit">
          记录跟进
        </van-button>
      </div>
      ...
      <div class="flex-1 overflow-y-auto">
        ...
        <div
          ...
          :key="record.id"
          class="py-2.5 border-b border-[#f0f0f0] last:border-b-0"
        >
          <div class="text-sm">
