...
| 审批流         | `approval/*`                                        | `modules/approvals`                                  | 🟡   | W2.5 已完成基础版本图；W3.7 DB-010 已完成四业务通用资源快照/UPDATE 回放/DELETE 延迟执行，DB-011 9.3A～C 已完成 ApprovalRecord、task nodeRound/type/action、BEFORE/AFTER 嵌套加签和节点退回/ReturnBackRecord/round 重建。仍待 9.3D 审批人任务撤回、9.3E requireComment/附件及 DB-012 条件/动态审批人/字段权限/Webhook。 |
