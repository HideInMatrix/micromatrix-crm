...
| 客户           | `customer/*`、`CustomerService`、`customerOverviewDrawer.vue`、Mobile `customer/index.vue/detail.vue` | `customers`             | 🟡   | W3.4.3 task 4.4 已完成协作、集团关系和合并深层规则；三字段合并、unique 自动去重、FollowUpPlan/关联 FK、协作继承、Owner History 与防环已验收，当前进入客户公海 4.5                    |
