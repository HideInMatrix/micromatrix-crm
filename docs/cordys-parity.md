...
| 客户           | `customer/*`、`CustomerService`、`customerOverviewDrawer.vue`、Mobile `customer/index.vue/detail.vue` | `customers`             | 🟡   | W3.4.3 task 4.5 已完成客户公海 `/pool/account/*`、Pool/Capacity/Reason 模块设置、领取/回收/库容规则及专项 API/Browser 验收；当前进入 task 4.6 客户域 Vue 页面最终对齐                         |
